...
class TestPassagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_passage" do
    assert_difference('TestPassage.count') do
      post test_passages_url, params: { test_passage: { correct_questions: @test_passage.correct_questions, current_questions_id: @test_passage.current_questions_id, test_id: @test_passage.test_id, user_id: @test_passage.user_id } }
    end
  ...
  test "should update test_passage" do
    patch test_passage_url(@test_passage), params: { test_passage: { correct_questions: @test_passage.correct_questions, current_questions_id: @test_passage.current_questions_id, test_id: @test_passage.test_id, user_id: @test_passage.user_id } }
